...
│ File  Debug                                                    │
├────────────────────────────────────────────────────────────────│
│ [Connect PLC]  [Manual Record]  [Settings…]                   │
├─────────────────────────┬──────────────────────────────────────│
│  Camera Preview         │  PLC Status                         │
│                         │   ● Connected  192.168.1.10:1025    │
│   (リアルタイム映像)      │                                     │
│   ~30 fps               │  Device States                      │
│                         │   M100  Trigger   ON                │
│                         │                                     │
│                         │  Active Recordings                  │
│                         │   Trigger: 20260330_153000_Trigger… │
│                         │                                     │
│                         │  Record Log                         │
│                         │   [15:30:00] Recording started…     │
│                         │   [15:30:10] Saved: 20260330_…mp4  │
└─────────────────────────┴──────────────────────────────────────│
│ Saved: C:\...\20260330_153000_Trigger.mp4                      │
└────────────────────────────────────────────────────────────────┘
```
